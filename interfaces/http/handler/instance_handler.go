...
func (h *InstanceHandler) StartInstance(c *gin.Context) {
	...
	id, err := h.startHandler.Handle(c.Request.Context(), cmd)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"code": 500,
			"msg":  err.Error(),
...
func (h *InstanceHandler) GetInstance(c *gin.Context) {
	...
	dto, err := h.queryService.GetInstanceByID(c.Request.Context(), id)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"code": 500,
			"msg":  err.Error(),
...
func (h *InstanceHandler) ListInstances(c *gin.Context) {
	...
	dtos, err := h.queryService.ListInstancesByWorkflowID(c.Request.Context(), workflowID, limit, offset)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"code": 500,
			"msg":  err.Error(),
