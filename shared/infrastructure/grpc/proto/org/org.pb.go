...
func (x *GetOrgByIdReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *GetOrgByCodeReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *GetOrgByNameReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *GetOrgFullNameReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
const file_org_proto_rawDesc = "" +
	...
	"\ttenant_id\x18\x01 \x01(\x05R\btenantId\x12\x19\n" +
