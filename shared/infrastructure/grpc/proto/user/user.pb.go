...
func (x *GetUserByIdReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *GetUserByPoliceNoReq) GetTenantId() int32 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *UserInfoReply) GetSex() int32 {
	if x != nil {
		return x.Sex
	}
	return 0
...
type RoleInfo struct {
	...
	DataScope     string                 `protobuf:"bytes,3,opt,name=data_scope,json=dataScope,proto3" json:"data_scope,omitempty"` // 数据权限范围：1-全部 2-角色 3-部门 4-部门及以下 5-仅本人
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RoleInfo) GetDataScope() string {
	if x != nil {
		return x.DataScope
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	...
	"\ttenant_id\x18\x01 \x01(\x05R\btenantId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x05R\x06userId\"P\n" +
	"\x14GetUserByPoliceNoReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\x05R\btenantId\x12\x1b\n" +
